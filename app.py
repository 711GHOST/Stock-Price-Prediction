...
app.layout = html.Div([
    html.H1('Predictor', style={"textAlign": "center", "margin_top":"8px"}),
    html.H2('Created By - Minor Project Team(Shwetanshu Sood, Vaibhav Sharma, Vinita Rai and Priyanshu Singh)', style={"textAlign": "center", "margin_top":"8px"}),
...
def update_graph(value):
    ...
    try:
        ...
        lstm_model = train_model(15,train_generator, 7)
